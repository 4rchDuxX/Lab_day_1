...
- Co říká port 31337? (hint: "Elite" je hakerský slang pro l33t)
...
Budeme analyzovat předpřipravený `.pcap` soubor s reálnou HTTP komunikací zachycenou v síti. Soubor je automaticky stažený v `lab-02-network/http.cap`.
...
cd /workspaces/appsec-training-lab/lab-02-network
...
Tohle je nejsilnější ukázka. Zobrazíme celou konverzaci mezi klientem a serverem:
